...
final class CablebinUITests: XCTestCase {
    ...
    func testAddFlow() {
        ...
        nameField.tap()
        nameField.typeText("UI Test Cable")
        app.buttons["saveButton"].tap()
        XCTAssertTrue(app.staticTexts["UI Test Cable"].waitForExistence(timeout: 2))
    }
